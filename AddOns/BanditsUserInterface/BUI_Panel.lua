...
local Disabled={
	...
	Assistans		=function()
					return not(
					IsCollectibleUnlocked(267) or IsCollectibleUnlocked(6376) or	--Banker
					IsCollectibleUnlocked(6378) or IsCollectibleUnlocked(301) or	--Trader
					IsCollectibleUnlocked(300)	--Smuggler
					)
					end,
	GearManager		=function()return not BUI_ShowGear end,
...
local PanelContent={
	...
	func		=function()BUI_ShowGear()end,
	var		="GearManager",
	disabled	=function()return not BUI_ShowGear end
	},
	{	--Minimap
...
--]]
	...
	func		=function()local id=IsCollectibleUnlocked(6376) and 6376 or 267 UseCollectible(id) SCENE_MANAGER:SetInUIMode()end,
	...
	func		=function()local id=IsCollectibleUnlocked(6378) and 6378 or 301 UseCollectible(id) SCENE_MANAGER:SetInUIMode()end,
