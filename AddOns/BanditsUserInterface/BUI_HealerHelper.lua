...
local function GetBuffsTarget()
	...
	for i=1, numBuffs do
		...
		if castByPlayer and target_buffs[buffName] then
			if TargetBuffs[buffName]==nil then TargetBuffs[buffName]=PERIOD/1000
			else TargetBuffs[buffName]=TargetBuffs[buffName]+PERIOD/1000 end
		end
	end
end
