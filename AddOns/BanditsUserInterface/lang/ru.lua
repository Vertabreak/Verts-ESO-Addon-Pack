...
HelperToolTip=
	...
	.."Поддерживать на маникене перечисленные дебафы\n"
...
BlackListAddDesc	="Введите точное название бафа (с соблюдением регистра) или его id. Так же можно добавлять бафы правым щелчком мыши по ним в панели бафов.",
...
Meter_Power	="Сила",
Meter_PowerDesc	="Показывает силу оружия и заклинаний игрока.",
Meter_Exp	="Опыт",
