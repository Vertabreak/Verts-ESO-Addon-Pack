...
DeleteMailDesc	="Skip confirmation dialog when deletting mails without attachments.",
...
DarkBrotherhoodSpreeDesc	="Non \"spree\" contracts will be skiped. Need to pres interact button again.",
...
Meter_CriminalDesc	="Shows bouty and heat timer.",
