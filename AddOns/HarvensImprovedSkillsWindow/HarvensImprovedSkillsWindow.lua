...
function HarvensImprovedSkillsWindow.AbilityOnMouseEnter(control)
	...
	elseif skillData:IsPassive() then
		...
		if rank <= maxRank then
			InitializeTooltip(HarvensSkillTooltipMorph2, control, TOPRIGHT, -5, -5, TOPLEFT)
			HarvensSkillTooltipMorph2:SetSkillLineAbilityId(skillData:GetProgressionData(rank):GetAbilityId(), skillType, skillLineIndex, skillIndex)
			if rank < maxRank then
				InitializeTooltip(HarvensSkillTooltipMorph1, HarvensSkillTooltipMorph2, TOPRIGHT, -5, 0, LEFT)
				HarvensSkillTooltipMorph1:SetSkillLineAbilityId(skillData:GetProgressionData(maxRank):GetAbilityId(), skillType, skillLineIndex, skillIndex)
			end
		end
	else
		InitializeTooltip(HarvensSkillTooltipMorph2, control, TOPRIGHT, -5, -5, TOPLEFT)
