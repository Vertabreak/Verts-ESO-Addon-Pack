...
function addon:InitSettings()
	...
	settings:AddSetting {
		type = LibHarvensAddonSettings.ST_CHECKBOX,
		label = GetString(SI_VOTANS_ADAPTIVE_SETTINGS_CHARACTER_LIGHTING),
		tooltip = GetString(SI_VOTANS_ADAPTIVE_SETTINGS_CHARACTER_LIGHTING_TOOLTIP),
		default = self.defaults.CharacterLighting,
		getFunction = function()
			return GetCVar(UserSettings.CharacterLighting) ~= "0"
		end,
		setFunction = function(value)
			SetCVar(UserSettings.CharacterLighting, value and "1" or "0")
		end
	}
	settings:AddSetting {
		type = LibHarvensAddonSettings.ST_CHECKBOX,
		label = GetString(SI_VOTANS_ADAPTIVE_SETTINGS_HIGH_RESOLUTION_SHADOWS),
		tooltip = GetString(SI_VOTANS_ADAPTIVE_SETTINGS_HIGH_RESOLUTION_SHADOWS_TOOLTIP),
		default = self.defaults.HighResolutionShadows,
		getFunction = function()
			return GetCVar(UserSettings.HighResolutionShadows) ~= "0"
		end,
		setFunction = function(value)
			SetCVar(UserSettings.HighResolutionShadows, value and "1" or "0")
		end
	}
	settings:AddSetting {
		type = LibHarvensAddonSettings.ST_CHECKBOX,
		label = GetString(SI_VOTANS_ADAPTIVE_SETTINGS_LENS_FLARE),
		tooltip = GetString(SI_VOTANS_ADAPTIVE_SETTINGS_LENS_FLARE_TOOLTIP),
		default = self.defaults.LensFlare,
		getFunction = function()
			return GetCVar(UserSettings.LensFlare) ~= "0"
		end,
		setFunction = function(value)
			SetCVar(UserSettings.LensFlare, value and "1" or "0")
		end
	}
	settings:AddSetting {
		type = LibHarvensAddonSettings.ST_CHECKBOX,
		label = GetString(SI_VOTANS_ADAPTIVE_SETTINGS_RAIN_WETNESS),
		tooltip = GetString(SI_VOTANS_ADAPTIVE_SETTINGS_RAIN_WETNESS_TOOLTIP),
		default = self.defaults.RainWetness,
		getFunction = function()
			return GetCVar(UserSettings.RainWetness) ~= "0"
		end,
		setFunction = function(value)
			SetCVar(UserSettings.RainWetness, value and "1" or "0")
		end
	}
	...
	settings:AddSetting {
		type = LibHarvensAddonSettings.ST_CHECKBOX,
		label = GetString(SI_VOTANS_ADAPTIVE_SETTINGS_SKIP_PREGAME_VIDEOS),
		tooltip = GetString(SI_VOTANS_ADAPTIVE_SETTINGS_SKIP_PREGAME_VIDEOS_TOOLTIP),
		default = self.defaults.HighResolutionShadows,
		getFunction = function()
			return GetCVar(UserSettings.SkipPregameVideos) ~= "0"
		end,
		setFunction = function(value)
			SetCVar(UserSettings.SkipPregameVideos, value and "1" or "0")
		end
	}
	do
		local format = {}
