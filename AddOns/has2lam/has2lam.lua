local LibHarvensAddonSettings = LibHarvensAddonSettings or LibStub and LibStub("LibHarvensAddonSettings-1.0")

local function HookLibHarvensAddonSettings()
	local lam = LibAddonMenu2 or LibStub and LibStub("LibAddonMenu-2.0", LibStub.SILENT)
