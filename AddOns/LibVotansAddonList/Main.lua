...
do
	local function InitializeModeBar(self)
		...
		local mainAddonsTab =
			CreateButtonData(SI_WINDOW_TITLE_ADDON_MANAGER, 1, "esoui/art/inventory/inventory_tabicon_misc_up.dds", "esoui/art/inventory/inventory_tabicon_misc_over.dds", "esoui/art/inventory/inventory_tabicon_misc_disabled.dds")
