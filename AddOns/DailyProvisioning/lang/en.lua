...
ZO_CreateStringId("DP_CRAFTING_EVENT1",     "Imperial Charity Writ")    -- [en.lang.csv] "242841733","0","167169","xxxxxxxx"
...
function DailyProvisioning:isAlchemy(journalCondition)
    return string.match(journalCondition, "Craft .* with the following .*raits") -- SI_MASTER_WRIT_QUEST_ALCHEMY_FORMAT_STRING
end
