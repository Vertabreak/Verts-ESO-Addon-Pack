...
ZO_CreateStringId("DP_CRAFTING_MASTER",     "A Masterful Feast")            -- [br.lang.csv] "52420949","0","5977","xxxxxxxx"
ZO_CreateStringId("DP_CRAFTING_WITCH",      "Witches Festival Writ")        -- [br.lang.csv] "52420949","0","6427","xxxxxxxx"
ZO_CreateStringId("DP_CRAFTING_EVENT1",     "Uma Contribuição de Caridade") -- [br.lang.csv] "52420949","0","6327","xxxxxxxx"
ZO_CreateStringId("DP_CRAFTING_EVENT1BOOK", "Imperial Charity Writ")        -- [br.lang.csv] "242841733","0","167169","xxxxxxxx"
...
function DailyProvisioning:ConvertedJournalCondition(journalCondition)
    ...
    local list = {
        ...
        {".+:Craft a%w* (.*)",              "Fabricar [%1]"},
      --{".+:Fabrique u%w+ (.*)",           "Fabrique [%1]"},
        {".+:Fabricar u%w+ (.*)",           "Fabricar [%1]"},

        -- Master Writ(in Journal)
        {"Craft a%w* (.*)...%sProgress:",   "Fabricar [%1]"},
      --{"Crie U%w+ (.*)• Progresso:",      "Fabrique [%1]"},
        {"Fabricar u%w+ (.*)• Progresso:",  "Fabricar [%1]"},
...
function DailyProvisioning:isProvisioning(journalCondition)
    local list = {
        "Fabrique u%w+ .* com os seguintes tracos",             -- [SI_MASTER_WRIT_QUEST_ALCHEMY_FORMAT_STRING] = "Fabrique <<1{um/uma}>> <<1>> com os seguintes traços:<<2>><<3>><<4>>\n• Progresso"
