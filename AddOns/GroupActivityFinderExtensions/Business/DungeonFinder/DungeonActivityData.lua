...
GAFE.DungeonActivityData={
    ...
    [ActivityId.NormalBlackDrakeVilla]		= {id=2831,     node=437    ,q=6576,    p=PledgeId.BlackDrakeVilla,     hm=false,   tt=false,   nd=false},
    ...
    [ActivityId.NormalCauldron]             = {id=2841,     node=454    ,q=6578,    p=PledgeId.Cauldron,            hm=false,   tt=false,   nd=false},
    ...
    --Veteran
    [ActivityId.VeteranFungalGrottoI]       = {id=1556,     node=98     ,q=3993, 	p=PledgeId.FungalGrottoI, 		hm=1561,	tt=1559,	nd=1560},
    [ActivityId.VeteranFungalGrottoII]      = {id=343,      node=266    ,q=4303, 	p=PledgeId.FungalGrottoII, 		hm=342,		tt=340,		nd=1563},
    [ActivityId.VeteranSpindleclutchI]      = {id=1565,     node=193    ,q=4054, 	p=PledgeId.SpindleclutchI, 		hm=1570,	tt=1568,	nd=1569},
    [ActivityId.VeteranSpindleclutchII]     = {id=421,      node=267    ,q=4555, 	p=PledgeId.SpindleclutchII,		hm=448,		tt=446,		nd=1572},
    [ActivityId.VeteranBanishedCellsI]      = {id=1549,     node=194    ,q=4107,    p=PledgeId.BanishedCellsI, 		hm=1554,	tt=1552,	nd=1553},
    [ActivityId.VeteranBanishedCellsII]     = {id=545,      node=262    ,q=4597,    p=PledgeId.BanishedCellsII,		hm=451,		tt=449,		nd=1564},
    [ActivityId.VeteranDarkshadeCavernsI]   = {id=1581,     node=264    ,q=4145, 	p=PledgeId.DarkshadeCavernsI,	hm=1586,	tt=1584,	nd=1585},
    [ActivityId.VeteranDarkshadeCavernsII]  = {id=464,      node=198    ,q=4641, 	p=PledgeId.DarkshadeCavernsII,	hm=467,		tt=465,		nd=1588},
    [ActivityId.VeteranEldenHollowI]        = {id=1573,     node=191    ,q=4336, 	p=PledgeId.EldenHollowI, 		hm=1578,	tt=1576,	nd=1577},
    [ActivityId.VeteranEldenHollowII]       = {id=459,      node=265    ,q=4675,    p=PledgeId.EldenHollowII, 		hm=463,		tt=461,		nd=1580},
    [ActivityId.VeteranWayrestSewersI]      = {id=1589,     node=189    ,q=4246, 	p=PledgeId.WayrestSewersI, 		hm=1594,	tt=1592,	nd=1593},
    [ActivityId.VeteranWayrestSewersII]     = {id=678,      node=263    ,q=4813, 	p=PledgeId.WayrestSewersII,		hm=681,		tt=679,		nd=1596},
    [ActivityId.VeteranArxCorinium]         = {id=1604,     node=192    ,q=4202, 	p=PledgeId.ArxCorinium, 		hm=1609,	tt=1607,	nd=1608},
    [ActivityId.VeteranCityOfAshI]          = {id=1597,     node=197    ,q=4778, 	p=PledgeId.CityOfAshI,			hm=1602,	tt=1600,	nd=1601},
    [ActivityId.VeteranCityOfAshII]         = {id=878,      node=268    ,q=5120, 	p=PledgeId.CityOfAshII, 		hm=1114,	tt=1108,	nd=1107},
    [ActivityId.VeteranCryptOfHeartsI]      = {id=1610,     node=190    ,q=4379, 	p=PledgeId.CryptOfHeartsI, 		hm=1615,	tt=1613,	nd=1614},
    [ActivityId.VeteranCryptOfHeartsII]     = {id=876,      node=269    ,q=5113, 	p=PledgeId.CryptOfHeartsII,		hm=1084,	tt=941,		nd=942},
    [ActivityId.VeteranDirefrostKeep]       = {id=1623,     node=195    ,q=4346, 	p=PledgeId.DirefrostKeep, 		hm=1628,	tt=1626,	nd=1627},
    [ActivityId.VeteranTempestIsland]       = {id=1617,     node=188    ,q=4538, 	p=PledgeId.TempestIsland, 		hm=1622,	tt=1620,	nd=1621},
    [ActivityId.VeteranVolenfell]           = {id=1629,     node=196    ,q=4432, 	p=PledgeId.Volenfell,			hm=1634,	tt=1632,	nd=1633},
    [ActivityId.VeteranBlackheartHaven]     = {id=1647,     node=186    ,q=4589, 	p=PledgeId.BlackheartHaven,		hm=1652,	tt=1650,	nd=1651},
    [ActivityId.VeteranBlessedCrucible]     = {id=1641,     node=187    ,q=4469, 	p=PledgeId.BlessedCrucible,		hm=1646,	tt=1644,	nd=1645},
    [ActivityId.VeteranSelenesWeb]          = {id=1635,     node=185    ,q=4733, 	p=PledgeId.SelenesWeb,			hm=1640,	tt=1638,	nd=1639},
    [ActivityId.VeteranVaultsOfMadness]     = {id=1653,     node=184    ,q=4822, 	p=PledgeId.VaultsOfMadness,		hm=1658,	tt=1656,	nd=1657},
    [ActivityId.VeteranBlackDrakeVilla]		= {id=2832,     node=437    ,q=6576,    p=PledgeId.BlackDrakeVilla,     hm=2833,    tt=2834,    nd=2835},
    [ActivityId.VeteranBloodrootForge]      = {id=1691,     node=326    ,q=5889, 	p=PledgeId.BloodrootForge, 		hm=1696,	tt=1694,	nd=1695},
	[ActivityId.VeteranCastleThorn]         = {id=2705,     node=436    ,q=6507,    p=PledgeId.CastleThorn, 		hm=2706,	tt=2707,	nd=2708},
    [ActivityId.VeteranCradleOfShadows]     = {id=1523,     node=261    ,q=5702, 	p=PledgeId.CradleOfShadows,		hm=1524,	tt=1525,	nd=1526},
    [ActivityId.VeteranDepthsOfMalatar]     = {id=2271,     node=390    ,q=6251, 	p=PledgeId.DepthsOfMalatar,		hm=2272,	tt=2273,	nd=2274},
    [ActivityId.VeteranFalkreathHold]       = {id=1699,     node=332    ,q=5891, 	p=PledgeId.FalkreathHold, 		hm=1704,	tt=1702,	nd=1703},
    [ActivityId.VeteranFangLair]            = {id=1960,     node=341    ,q=6064, 	p=PledgeId.FangLair,			hm=1965,	tt=1963,	nd=1964},
    [ActivityId.VeteranFrostvault]          = {id=2261,     node=389    ,q=6249, 	p=PledgeId.Frostvault,			hm=2262,	tt=2263,	nd=2264},
    [ActivityId.VeteranIcereach]            = {id=2540,     node=424    ,q=6414, 	p=PledgeId.Icereach, 			hm=2541,	tt=2542,	nd=2543},
    [ActivityId.VeteranImperialCityPrison]  = {id=880,      node=236    ,q=5136, 	p=PledgeId.ImperialCityPrison,	hm=1303,	tt=1128,	nd=1129},
    [ActivityId.VeteranLairOfMaarselok]     = {id=2426,     node=398    ,q=6351, 	p=PledgeId.LairOfMaarselok,		hm=2427,	tt=2428,	nd=2429},
    ...
    [ActivityId.VeteranCauldron]            = {id=2842,     node=454    ,q=6578,    p=PledgeId.Cauldron,            hm=2843,    tt=2844,    nd=2845},
    [ActivityId.VeteranUnhallowedGrave]     = {id=2550,     node=425    ,q=6416, 	p=PledgeId.UnhallowedGrave,		hm=2551,	tt=2552,	nd=2553},
    [ActivityId.VeteranWhiteGoldTower]      = {id=1120,     node=247    ,q=5342, 	p=PledgeId.WhiteGoldTower, 		hm=1279,	tt=1275,	nd=1276},
}