...
ZO_CreateStringId("DA_CRAFTING_WITCH",      "Заказ на Праздник ведьм")  -- [ru.lang.csv] "52420949","0","6427","xxxxxxxx"
...
function DailyAlchemy:ConvertedJournalCondition(journalCondition)
    local list = {
        ...
        {"Увеличение магической сопротив%c", "Увеличение магической сопротивляемости\n"}, -- [ru.lang.csv] "156152165","0","7","xxxxxxxx"
        {"Увеличение магической сопротив$",  "Увеличение магической сопротивляемости"},   -- [ru.lang.csv] "156152165","0","7","xxxxxxxx"
        {" IX([):%s])",   " Ⅸ%1"},
        {" VIII([):%s])", " Ⅷ%1"},
        {" VII([):%s])",  " Ⅶ%1"},
        {" VI([):%s])",   " Ⅵ%1"},
        ...
        {" II([):%s])",   " Ⅱ%1"},
        {" I([):%s])",    " Ⅰ%1"},
        {"Создать предмет (.*) со .*%c• (.*)%c• (.*)%c• (.*)%c%c.*",  "Создать предмет %1...%2, %3, %4"}, -- SI_MASTER_WRIT_QUEST_ALCHEMY_FORMAT_STRING
        {".* предмета (.*) со .*%c• (.*)%c• (.*)%c• (.*)",                  "Создать предмет %1...%2, %3, %4"}, -- SI_MASTER_WRIT_ITEM_ALCHEMY_FORMAT_STRING
        {":.*", ""}, 

        ---[Potion]---------------------------------------------------------------------------------------------------------------------
        -- [ru.lang.csv] "7949764","0","44927","xxxxxxxx","Создать панацею здоровья"
        -- [ru.lang.csv] "7949764","0","44945","xxxxxxxx","Создать панацею магии"
        -- [ru.lang.csv] "7949764","0","44963","xxxxxxxx","Создать панацею запаса сил"
        -- [ru.lang.csv] "7949764","0","44981","xxxxxxxx","Создать панацею опустошения здоровья"
        -- [ru.lang.csv] "41983653","0","142","xxxxxxxx","панацея"
        {"Создать панацею ",   "Создать панацея "},

        -- [ru.lang.csv] "7949764","0","47328","xxxxxxxx","Создать эссенцию здоровья"
        -- [ru.lang.csv] "7949764","0","47332","xxxxxxxx","Создать эссенцию магии"
        -- [ru.lang.csv] "7949764","0","47334","xxxxxxxx","Создать эссенцию запаса сил"
        -- [ru.lang.csv] "7949764","0","47337","xxxxxxxx","Создать эссенцию опустошения здоровья"
        -- [ru.lang.csv] "41983653","0","199","xxxxxxxx","Эссенция"
        {"Создать эссенцию ", "Создать Эссенция "},

        -- [ru.lang.csv] "7949764","0","44918","xxxxxxxx","Создать драхму здоровья"
        -- [ru.lang.csv] "7949764","0","44936","xxxxxxxx","Создать драхму магии"
        -- [ru.lang.csv] "7949764","0","44954","xxxxxxxx","Создать драхму запаса сил"
        -- [ru.lang.csv] "7949764","0","44972","xxxxxxxx","Создать драхму опустошения магии"
        -- "41983653","0","74","xxxxxxxx","драхма"
        {"Создать драхму ", "Создать драхма "},


        ---[Poison]---------------------------------------------------------------------------------------------------------------------
        -- [ru.lang.csv] "7949764","0","56972","xxxxxxxx","Создать яд поглощения здоровья IX"
        -- [ru.lang.csv] "242841733","0","76826","xxxxxxxx","Яд высасывания здоровья"
        {"яд поглощения здоровья", "Яд высасывания здоровья"},

        -- [ru.lang.csv] "7949764","0","56975","xxxxxxxx","Создать яд упадка сил IX"
        -- [ru.lang.csv] "242841733","0","76831","xxxxxxxx","Яд урона запасу сил"
        {"яд упадка сил", "Яд урона запасу сил"},

        -- [ru.lang.csv] "7949764","0","56978","xxxxxxxx","Создать яд антимагии IX"
        -- [ru.lang.csv] "242841733","0","76829","xxxxxxxx","Яд урона магии"
        {"яд антимагии", "Яд урона магии"},

        -- [ru.lang.csv] "7949764","0","56981","xxxxxxxx","Создать яд нездоровья IX"
        -- [ru.lang.csv] "242841733","0","76827","xxxxxxxx","Яд урона здоровью"
        {"яд нездоровья", "Яд урона здоровью"},


        ---[ITEM]---------------------------------------------------------------------------------------------------------------------
        -- [ru.lang.csv] "7949764","0","44970","xxxxxxxx","Добыть природную воду"
        -- [ru.lang.csv] "242841733","0","883","xxxxxxxx","природная вода"
        {"Добыть природную воду", "природная вода"},

        -- [ru.lang.csv] "7949764","0","44973","xxxxxxxx","Добыть нетронутую воду"
        -- [ru.lang.csv] "242841733","0","4570","xxxxxxxx","нетронутая вода"
        {"нетронутую воду", "нетронутая вода"},

        -- [ru.lang.csv] "7949764","0","44977","xxxxxxxx","Добыть фильтрованную воду"
        -- [ru.lang.csv] "242841733","0","23266","xxxxxxxx","фильтрованная вода"
        {"фильтрованную воду", "фильтрованная вода"},


        -- [ru.lang.csv] "7949764","0","44979","xxxxxxxx","Добыть дистиллированную воду"
        -- [ru.lang.csv] "242841733","0","23267","xxxxxxxx","дистиллированная вода"
        {"дистиллированную воду", "дистиллированная вода"},

        -- [ru.lang.csv] "7949764","0","44982","xxxxxxxx","Добыть очищенную воду"
        -- [ru.lang.csv] "242841733","0","23265","xxxxxxxx","очищенная вода"
        {"очищенную воду", "очищенная вода"},
