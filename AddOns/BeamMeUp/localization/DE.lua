...
mkstr(SI.TELE_CHAT_WHISPER_NOTE, "Achtung! Du bist auf offline gestellt und kannst somit keine Flüster-Nachrichten empfangen!")
...
mkstr(SI.TELE_SETTINGS_WHISPER_NOTE, "Flüster-Hinweis")
mkstr(SI.TELE_SETTINGS_WHISPER_NOTE_TOOLTIP, "Wenn du auf offline gestellt bist und jemanden anflüsterst, bekommst du im Chat einen Hinweis, dass du keine Flüsternachrichten empfangen kannst. Diese Funktion hilft dir, ungewolltes Blockieren von Antworten zu vermeiden.")
...
mkstr(SI.TELE_SETTINGS_PRIORITIZATION_DESCRIPTION, "Hier kannst du einstellen, welche Spieler vorzugsweise für die Schnellreise genutzt werden sollen. Nach dem Beitritt oder Verlassen einer Gilde ist ein Reload erforderlich, um hier korrekt angezeigt zu werden. |ca20000Diese Option ist an deinem Charakter gebunden (nicht account wide)!|r")
mkstr(SI.TELE_SETTINGS_SCAN_BANK_FOR_MAPS, "Scanne deine Bank nach Karten")
mkstr(SI.TELE_SETTINGS_SCAN_BANK_FOR_MAPS_TOOLTIP, "Scanne zusätzlich deine Bank nach Fundberichten und Schatzkarten.")
...
mkstr(SI.TELE_SETTINGS_SCAN_LEADS, "Zeige erspähbare Spuren")
mkstr(SI.TELE_SETTINGS_SCAN_LEADS_TOOLTIP, "Zeigt erspähbare Spuren zusammen mit Schatzkarten und Fundberichten an.")
