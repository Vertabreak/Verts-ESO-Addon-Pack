...
mkstr(SI.TELE_CHAT_WHISPER_NOTE, "Uwaga! Jesteś ustawiony jako offline i nie możesz otrzymyważ szeptów!")
...
mkstr(SI.TELE_SETTINGS_WHISPER_NOTE, "Nota o szeptach")
mkstr(SI.TELE_SETTINGS_WHISPER_NOTE_TOOLTIP, "Po wejściu w tryb offline i szeptnięciu do kogoś pojawi się wiadomość na czacie, że nie można odbierać żadnych wiadomości w szeptach. Ta funkcja pozwala uniknąć niechcianego blokowania odpowiedzi.")
...
mkstr(SI.TELE_SETTINGS_PRIORITIZATION_DESCRIPTION, "Możesz wybrać, którzy gracze będą preferowani w opcji szybkiej podróży. Po opuszczeniu lub przyłączeniu się do gildii, odświeżenie jest potrzebne by poprawnie wyświetlić. |ca20000Ta opcja jest przypięta do postaci (nie całego konta)!|r")
mkstr(SI.TELE_SETTINGS_SCAN_BANK_FOR_MAPS, "Poszukaj map w banku")
mkstr(SI.TELE_SETTINGS_SCAN_BANK_FOR_MAPS_TOOLTIP, "Dodatkowo przeszukuje Twój bank w poszukiwaniu map surowców i skarbów.")
...
mkstr(SI.TELE_SETTINGS_SCAN_LEADS, "Pokaż wskazówki do wizji")
mkstr(SI.TELE_SETTINGS_SCAN_LEADS_TOOLTIP, "Pokaż swoje wskazówki do wizji razem z mapami skarbów i surowców.")
